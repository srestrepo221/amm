...
describe('AMM', () => {
  ...
  describe('Swapping tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      // Check price before swapping (should basically be 1)
      console.log(`Price: ${await amm.token2Balance() / await amm.token1Balance()} \n`)

      // Investor approves all tokens
      transaction = await token1.connect(investor1).approve(amm.address, tokens(10000))
      await transaction.wait()
      ...
      // Estimate amount of tokens investor1 will receieve after swapping token1: include slippage
      ...
      /////////////////////////////////////////////////////////////
      // Investor 2 Swaps a large amount
      //
      ...
      // AMM Pool should have 100 total shares
